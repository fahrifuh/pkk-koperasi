            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#transaksiModal"
                            data-id="{{ $item['id'] }}" onclick="showDetail(this)">
                            Lihat detail
                        </button>
                    </td>
                </tr>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.each(res.data, function(key, value) {
                    ...
                    var html = `
                <div>
                    <span>${no} . </span> <p>Jenis Simpanan : ${value.jenis_simpanan}</p>   
